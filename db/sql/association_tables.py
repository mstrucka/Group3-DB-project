...
course_progresses = Table('course_progresses', Base.metadata,
    Column('enrollment_id', ForeignKey('enrollment.id', ondelete='CASCADE'), primary_key=True, index=True),
    Column('finished_lecture_id', ForeignKey('lecture.id', ondelete='CASCADE'), primary_key=True, index=True),
)
